...
$(function(){
	...
	skel.init({
		...
		breakpoints: {
			...
			wide:		{ range: '-1680', href: 'css/style-wide.css', containers: 1200, grid: { zoom: -1, gutters: 40 } },
			...
			narrower:	{ range: '-840', href: 'css/style-narrower.css', containers: '85%!', grid: { zoom: 3 } },
			mobile:		{ range: '-736', href: 'css/style-mobile.css', containers: '100%!', grid: { zoom: 4 } }
		},
		plugins: {
			layers: {
				config: {
